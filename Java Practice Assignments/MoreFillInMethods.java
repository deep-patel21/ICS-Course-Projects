...
/*
 public static _____ superrand(_____) {
 // Parameters are:
 // int a;
 // int b;
...
/*
  public static _____ stepcount(_____) {
 // Parameters are:
 //     int first;
 //     int last;
 //     int step;
...
/*
 public static _____ project_grade(_____) {
 // Parameters are:
...
/*
 public static _____ get_name(_____) {
 // No parameters.
...
/*
 public static _____ crash(_____) {
 // No parameters.
